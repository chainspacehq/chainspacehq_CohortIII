...
// Import gallery images for first cohort
...
const FirstCohort = () => {
  ...
  const galleryImages = [{
    src: eventPresentation,
    title: "Program Launch Event",
    description: "Opening ceremony with participants and lighting effects"
  }, {
    src: codingSession1,
    title: "Intensive Coding Session",
    description: "Students working on blockchain development projects"
  }, {
    src: codingSession2,
    title: "Collaborative Learning",
    description: "Team-based learning and peer collaboration"
  }, {
    src: classroomSession,
    title: "Classroom Engagement",
    description: "Interactive learning session with instructor guidance"
  }, {
    src: workshopSession,
    title: "Hands-on Workshop",
    description: "Practical blockchain development training"
  }, {
    src: presentationScreen,
    title: "Technical Presentations",
    description: "Students presenting their project work"
  }, {
    src: groupPhoto1,
    title: "Cohort Group Photo",
    description: "First cohort team celebration"
  }, {
    src: groupPhoto2,
    ...
    description: "Instructor explaining smart contract development"
  }];
  const nextImage = () => {
  ...
  return <section className="relative min-h-screen bg-chainspace-black py-20">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-chainspace-orange text-xl font-semibold">
            FIRST BATCH • 18 GRADUATES • 12 EMPLOYED
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="relative max-w-4xl mx-auto mb-8">
            <div className="starburst bg-chainspace-dark-gray border-2 border-chainspace-orange rounded-2xl p-4 overflow-hidden">
      ...
      {selectedImage && <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4" onClick={closeImageModal}>
          ...
          e.stopPropagation();
          navigateModal('prev');
        }} className="absolute left-4 top-1/2 -translate-y-1/2 z-10 bg-chainspace-orange/80 text-chainspace-black rounded-full p-3 hover:bg-chainspace-orange transition-colors" aria-label="Previous image">
          ...
          e.stopPropagation();
          navigateModal('next');
        }} className="absolute right-4 top-1/2 -translate-y-1/2 z-10 bg-chainspace-orange/80 text-chainspace-black rounded-full p-3 hover:bg-chainspace-orange transition-colors" aria-label="Next image">
            ...
            return currentImage && <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 rounded-b-lg">
